    ...
    submitMessage = () => {
        ...
        if(username){
            if( this.state.messageInput ){
                this.props.dispatch({ type : "messages/ADD_MESSAGE_ASYNC", payload : { username, content : this.state.messageInput } }).then(
                            ...
                            return (
                                <li key={item._id} className={styles.listItem}>
                                    <div className={ styles.profile }>
                                        <img src={ item.profile || require("../../assets/img/lufei_01.jpg") } alt=""/>
                                    </div>
